...
void UABGameplayWidget::NativeConstruct()
{
	...
	ResumButton = Cast<UButton>(GetWidgetFromName(TEXT("btnResume")));
	if (nullptr != ResumButton)
	{
		ResumButton->OnClicked.AddDynamic(this, &UABGameplayWidget::OnResumeClicked);
	}
