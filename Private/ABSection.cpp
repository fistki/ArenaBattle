...
AABSection::AABSection()
{
	...
	{
		ABLOG(Error, TEXT("Failed to load sttaticmesh asset. : %s"), *AssetPath);
	}

	Trigger = CreateDefaultSubobject<UBoxComponent>(TEXT("TRIGGER"));
	Trigger->SetBoxExtent(FVector(775.0f, 775.0f, 330.0f));
	...
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	FName SocketName = FName(*ComponentTag.ToString().Left(2));	// +X, -X, +Y, -Y 소켓을 의미
	...
	FCollisionObjectQueryParams ObejectQueryParams(FCollisionObjectQueryParams::InitType::AllObjects);
